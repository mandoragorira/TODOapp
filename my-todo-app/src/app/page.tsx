...
"use client"; // このページはウェブブラウザ側で動かすよ！っていうおまじない

import { useState, useEffect } from 'react'; // Reactの機能を使うためのimport
import { Task } from '@/types/task'; // 作ったTaskの設計図を読み込む
import { loadTasks, saveTasks, toggleTaskCompletion, deleteTask } from '@/lib/taskStorage'; // タスクの倉庫番から関数を読み込む
